...
> **错误回退规则**见 `hany-common/procedures/error_backoff.md`
...
2. **隐性 bug 质疑**：代码能跑 ≠ 逻辑对。有没有静默失败的情况？
3. **回归风险质疑**：这次修改有没有可能影响到其他功能？
